...
public class CarpoolSearchResultsListFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        Bundle args2 = intent.getBundleExtra("BUNDLE_JOINED");

        int pos = intent.getIntExtra("i", 0);

        if(args != null){
            carpoolsArray = (ArrayList<Carpool>) args.getSerializable("searchResults");
        }
        else if(pos == 0){
            carpoolsArray = (ArrayList<Carpool>) args1.getSerializable("createdCarpools");
        }
        else if(pos == 1){
            carpoolsArray = (ArrayList<Carpool>) args2.getSerializable("joinedCarpools");
        }
